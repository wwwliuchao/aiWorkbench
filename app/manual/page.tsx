...
const featureSections = [
  ...
  },
  {
    ...
    bullets: [
      "首页和目录页的搜索框支持按名称、说明、负责人、主要负责部门、标签搜索。",
      "统计页支持按日期范围和应用类型筛选数据。",
  ...
  },
  {
    ...
    bullets: [
      ...
      "任务列表显示任务名称、部门、需求文档、相关资料、状态、创建时间等信息。",
  ...
  },
  {
    ...
    bullets: [
      ...
      "可维护应用入口，包括名称、说明、负责人、主要负责部门、链接、标签等字段；负责人和部门从 EIP 业务库中选择并保存引用 ID。",
      "可维护 RPA 任务的需求文档和相关资料地址，便于业务用户查看任务说明与配套资料。"
    ],
    steps: [
      "新增目录前，先确定业务分类和层级关系。",
